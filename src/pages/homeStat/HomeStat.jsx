...
const HomeStat = () => {
    ...
    useEffect(() => {
        axios
            .get("https://servicia-server.vercel.app/countData")
            .then((res) => {
                setCount(res.data);
            });
    }, []);
    ...
    return (
        <div className="bg-[#357ef0] p-4 py-10 flex flex-col md:flex-row justify-center md:justify-around text-white text-center gap-4 my-10 items-center">
